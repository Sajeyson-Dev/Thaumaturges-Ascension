...
val beast1          as string = 'bestia 2';
val beast2          as string = 'bestia 3';
val beast3          as string = 'bestia 5';

val plant1          as string = 'herba 2';
val plant2          as string = 'herba 3';
val plant3          as string = 'herba 5';

val undead1         as string = 'exanimis 2';
val undead2         as string = 'exanimis 3';
val undead3         as string = 'exanimis 5';

val strange1        as string = 'alienis 2';
val strange2        as string = 'alienis 3';
val strange3        as string = 'alienis 5';

val mechanical1     as string = 'machina 2';
val mechanical2     as string = 'machina 3';
val mechanical3     as string = 'machina 5';

val armored1        as string = 'tutamen 2';
val armored2        as string = 'tutamen 3';
val armored3        as string = 'tutamen 5';

val metal1          as string = 'metallum 2';
val metal2          as string = 'metallum 3';
val metal3          as string = 'metallum 5';

val flying          as string = 'aer 2';
val earthy          as string = 'terra 2';
val fiery           as string = 'ignis 2';
val aquatic         as string = 'aqua 2';
val gentleman       as string = 'ordo 2';
val dumbo           as string = 'perditio 2';
val powerful        as string = 'potentia 2';
val spirit          as string = 'spiritus 2';
val human           as string = 'humanus 2';
val hungry          as string = 'fames 2, vacuos 2';
val deadly          as string = 'mortuus 2';
val shady           as string = 'tenebrae 2';
val bird            as string = 'volatus 2';
val tree            as string = 'arbor 2';
val cold            as string = 'gelum 2';
val toxic           as string = 'venenum 2';
val mage            as string = 'praecantatio 2';
val smart           as string = 'cognitio 2';
val moving          as string = 'motus 2';
val geared          as string = 'telum 2';
val traveller       as string = 'iter 2';
val shiny           as string = 'lucrum 2';
val angrybones      as string = 'corpus 2';
val life            as string = 'victus 2';
val crystal         as string = 'vitreus 2';
val slime           as string = 'limus 2';
val light           as string = 'lux 2';
val void_           as string = 'vacuos 2';
val trap            as string = 'vinculum 2';
val tools           as string = 'instrumentum 2';
val mining          as string = 'perfodio 2';
val harvest         as string = 'meto 2';
val crop            as string = 'messis 2';
val barter          as string = 'permutatio 2';
val aura            as string = 'auram 2';
val sense           as string = 'sensus 2';

#category Misc Entities
...
#category Masters of Skills Npc
