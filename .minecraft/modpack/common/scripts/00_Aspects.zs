...
#category Ancient Cavern Blocks
...
#category Ancient Cavern Foliage
for item in [
...
#category Natura Stuff
add(<Natura:Bluebells>, 'herba 1');

#category Reliquary Stuff
...
#category Pam's HarverstCraft Stuff
for candle in [
...
#category Chisel Thaumium
add(<chisel:thaumium:*>, 'metallum 1, praecantatio 1');


#category Chisel Gem Stuff
for item in [
    <chisel:beacon:*>,
