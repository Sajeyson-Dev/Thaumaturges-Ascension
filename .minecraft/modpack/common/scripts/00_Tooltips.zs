...
function addWorldGenTooltip(item as IItemStack, dimension as string, Ylvl as string, bestY as string) as void {
    item.addTooltip(format.green("Generates in the " + format.gold(dimension) + format.green(" between Y: " + format.gold(Ylvl + ". ")) + format.green("Best Y: " + format.gold(bestY))));
}
...
addShiftTooltip2(<nevermine:NethengeicCallstone>, "Summons Nethengeic Wither.", "Dropped from Nethengeic Beasts with a 10% chance in a Nethengeic Pits (found in The Nether).");
addShiftTooltip2(<nevermine:AncientOrb>, "Use it on the Army Block (found in the Skelatal Arena) to summon Skeletal Army.", "Dropped from Kaiyu with a 3% chance in a Kaiyu Temples (found in Precasia).");
addShiftTooltip2(<nevermine:HeavyBoulder>, "Use it on the Rockrider Shrine (found in The Haven on the Rockrider Boulder) to summon Rockrider.", "Dropped from Terradon (rare Precasian mob) with a 100% chance.");
addShiftTooltip2(<nevermine:PedalPile>, "Use it on the Vinocorne Altar (found in Gardencia in the Floro Castle) to summon Vonocorne.", "Crafted from 5 flower petals (dropped from Gardensian mobs) on the Petal Crafting Station (found in Garden Castle).");
addShiftTooltip(<nevermine:CallOfTheDrake>, "Use it on the Dracyon Altar (found on the Dracyon Platform) to summon Dracyon.");
addShiftTooltip2(<nevermine:HiveChunk>, "Use it on the Hive Spawner (found in the Baron Hive) to summon Hive King.", "Dropped from Parasects with a 1.7% chance in Underground Barathos.");
addShiftTooltip2(<nevermine:CoinSilvro>, "Use it on the Silverfoot Altar (found in the Iro Maze) to summon Silverfoot.", "Bought from Professor in Professor's Lab.");
addShiftTooltip2(<nevermine:BoulderDash>, "Use it on the Kror Altar (found near the Kror Pillar) to summon Kror.", "Crafted with Heavy Boulder and Primordal Dust on the Charging Table (found in Charging Fountains).");
addShiftTooltip2(<nevermine:BookOfShadows>, "Use it on the Shadow Altar (found on the Shadowlord Platform) to summon Shadowlord.", "Dropped from Apparition and Web Reapers with a 5% chance and Shades with a 2.5% chance.");
addShiftTooltip2(<nevermine:PrimordialDust>, "Use it on all Dustopian Lamps, then on Primordal Shrine (found in the Dustopia) to summon Primordal Five.", "Bought from Primordal Merchant.");
addShiftTooltip2(<nevermine:StaringEye>, "Use it on the Illusion Altar (found under the Illusion Tree) to summon Elusive.", "Dropped from Flesh Eaters with a 10% chance in Flesh Temples (found in The Abyss).");
addShiftTooltip2(<nevermine:ToyGyrocopter>, "Use it on the Toy Box (found on the Gyro Platform) to summon Gyro.", "Bought from Toy Merchant.");
addShiftTooltip2(<nevermine:GuardiansEye>, "Use it on the Graw Altar (found it the Graw Pillar) to summon Graw.", "Dropped from Lelyetian Warriors and Lelyetian Casters with a 5% chance.");
addShiftTooltip2(<nevermine:GiantCrystal>, "Use it on the Power Station (found on the Crystocore Station structure) to summon Crystocore.", "Bought from Crystal Trader.");
addShiftTooltip(<nevermine:HauntedIdol>, "Summons Bane.");
addShiftTooltip2(<nevermine:ShroomStone>, "Summons King Shroomus.", "Dropped from Fungik, Fungback, Fungat with a 1% chance and from Fungung with a 100% chance.");
addShiftTooltip2(<nevermine:VoliantHeart>, "Use it on the Guardian Altar (found on the Guardian's Tower) to summon Four Guardians.", "Dropped from Voliants (rare flying Haven mob) with a 100% chance.");
addShiftTooltip(<nevermine:ExplosiveGem>, "Use it on the Creep Altar (found on the Creeper HQ structure) to summon C.R.E.E.P.");
addShiftTooltip(<nevermine:MegaRuneStone>, "Use it on the Clunkhead Altar (found on the Clunkhead Arena) to summon Clunkhead.");
addShiftTooltip(<nevermine:TreatBag>, "Use it on the Candy Block (found on the Cotton Candy Tower) to summon Cotton Candor.");
addShiftTooltip2(<nevermine:ObservingEye>, "Use it on the Visualent Altar (found on the Observer's Eye structure) to summon Visualent.", "Dropped from Visulon (rare flying Lunalus mob) with a 100% chance.");
addShiftTooltip2(<nevermine:VileStone>, "Use it on the Voxxulon Altar (found on the Voxxulon Platform) to summon Voxxulon.", "Crafted from Uncharged Stone on the Enigma Table (Found at the Enigma Station structure).");
addShiftTooltip2(<nevermine:AncientRing>, "Use it on the Craexxeus Altar (found in the Craexxeus Tower) to summon Craexxeus", "Obtained by using Shyregem Ingot on the Ancient Altar with a 25% chance and Shyrestone with a 12.5%.");
...
addWorldGenTooltip(<nevermine:oreMystite>, "Mysterium", "1-40", "?");
addWorldGenTooltip(<nevermine:oreCrystallite>, "Haven", "~", "?");
addWorldGenTooltip(<nevermine:oreChargedRunium>, "Deeplands", "~", "?");
...
addWorldGenTooltip(<nevermine:oreBloodstone>, "Abyss", "1-50", "?");
...
addWorldGenTooltip(<nevermine:oreVarsium>, "Barathos", "~", "?");
...
addWorldGenTooltip(<nevermine:oreGhastly>, "Creckon", "~", "?");
addWorldGenTooltip(<nevermine:oreGhoulish>, "Creckon", "~", "?");
