...
Arcane.addShaped("ENCHFABRIC", goldenBag, "aer 60, ordo 56", [
    [enchFabric, thaumium, enchFabric],
    [enchFabric, goldChest, enchFabric],
    [enchFabric, goldBlock, enchFabric]
]);

Arcane.addShapeless("GOLDEN_BAG", <ExtraUtilities:golden_bag>.withTag({enchanted: 1 as byte}), "ordo 32",
    [goldenBag, ghostlyStone, ghostlyStone, ghostlyStone, ghostlyStone, ghostlyStone, ghostlyStone, ghostlyStone, ghostlyStone
]);
