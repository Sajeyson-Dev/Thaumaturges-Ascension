...
newResearch(angelRing, "ARTIFICE", true, "aer 1, terra 1, ordo 1, volatus 1, iter 1, humanus 1, potentia 1, lucrum 1, motus 1, cognitio 1, sensus 1", 2, 8, 5, <ExtraUtilities:angelRing>);
...
newResearch(runes, "ARTIFICE", false, "iter 1, praecantatio 1, sensus 1, motus 1, vacuos 1", -1, -5, 5, <nevermine:CarvedRune4>);
...
setUlockable(unstableIngot, "mortuus 20, perditio 60, metallum 16");
